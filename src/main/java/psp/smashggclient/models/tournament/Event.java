...
public class Event {
    ...
    private List<PlatformID> platformIDS;
    ...
    public List<PlatformID> getPlatformIDS() { return platformIDS; }
    @JsonProperty("platformIds")
    public void setPlatformIDS(List<PlatformID> value) { this.platformIDS = value; }
    ...
    public List<Object> getGameModeConfig() { return gameModeConfig; }
    @JsonProperty("gameModeConfig")
    public void setGameModeConfig(List<Object> value) { this.gameModeConfig = value; }
    ...
    public List<Object> getRulesetSettings() { return rulesetSettings; }
    @JsonProperty("rulesetSettings")
    public void setRulesetSettings(List<Object> value) { this.rulesetSettings = value; }
    ...
    public List<Object> getStations() { return stations; }
    @JsonProperty("stations")
    public void setStations(List<Object> value) { this.stations = value; }

    @JsonProperty("streams")
    public List<Object> getStreams() { return streams; }
    @JsonProperty("streams")
    public void setStreams(List<Object> value) { this.streams = value; }

    @JsonProperty("waves")
    public List<Object> getWaves() { return waves; }
    @JsonProperty("waves")
    public void setWaves(List<Object> value) { this.waves = value; }
