...
public class Phase {
    ...
    private List<Object> bracketMap;
    ...
    public List<Object> getBracketMap() { return bracketMap; }
    @JsonProperty("bracketMap")
    public void setBracketMap(List<Object> value) { this.bracketMap = value; }
    ...
    @JsonProperty("groups")
    public void setGroups(List<Object> value) { this.groups = value; }
