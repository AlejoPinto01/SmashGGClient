...
public class TournamentPublishing {
    ...
    private List<Object> featureTab;
    ...
    public List<Object> getFeatureTab() { return featureTab; }
    @JsonProperty("feature_tab")
    public void setFeatureTab(List<Object> value) { this.featureTab = value; }

    @JsonProperty("feedback")
    public List<Object> getFeedback() { return feedback; }
    @JsonProperty("feedback")
    public void setFeedback(List<Object> value) { this.feedback = value; }
