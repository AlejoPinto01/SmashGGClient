...
public class Entrant {
    ...
    @JsonProperty("participantIds")
    public void setParticipantIDS(long[] value) { this.participantIDS = value; }
    ...
    @JsonProperty("expand")
    public Object[] getExpand() { return expand; }
    @JsonProperty("expand")
    public void setExpand(Object[] value) { this.expand = value; }
